...
class MyIRCBot(SingleServerIRCBot):
	def __init__(self, channel, nickname, server, port=6667, ssl=False):
		SingleServerIRCBot.__init__(self, [(server, port)], nickname, nickname, ssl)
	...
	def on_welcome(self, c, e):
		c.join(self.channel) # todo: join multiple channels.
...
def main():
	...
	bot = MyIRCBot(channel, nickname, server, port, True)
	bot.start()
