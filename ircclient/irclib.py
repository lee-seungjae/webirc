...
class IRC:
    ...
    def __init__(self, fn_to_add_timeout=None):
        ...
        The argument mainly exist to be able to use an external
...
class ServerConnection(Connection):
    ...
    def __init__(self, irclibobj, sender, dispatcher, nickname, password=None, username=None, ircname=None):
        """Initializes a ServerConnection object.
